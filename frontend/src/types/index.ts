...
export interface ReviewTask {
  ...
  created_at: string; updated_at: string; files?: ReviewFile[]; report_id?: string | null
}
export interface Finding { severity: Severity; category: string; title: string; description: string; file_path: string; line?: number | null; remediation: string }
