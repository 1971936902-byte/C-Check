...
load_env() {
  ...
  CANDIDATE_MODEL_MAX_TOKENS="${CANDIDATE_MODEL_MAX_TOKENS:-2048}"
  MODEL_STRUCTURED_OUTPUTS_ENABLED="${MODEL_STRUCTURED_OUTPUTS_ENABLED:-true}"
  CANDIDATE_FORMAT_MODEL_ENABLED="${CANDIDATE_FORMAT_MODEL_ENABLED:-true}"
  CANDIDATE_FORMAT_BATCH_SIZE="${CANDIDATE_FORMAT_BATCH_SIZE:-10}"
  RAG_EMBEDDING_BACKEND="${RAG_EMBEDDING_BACKEND:-hashing}"
  RAG_EMBEDDING_MODEL="${RAG_EMBEDDING_MODEL:-hashing-code-embedding-v1}"
  RAG_EMBEDDING_DIMENSION="${RAG_EMBEDDING_DIMENSION:-128}"
}
...
CANDIDATE_MODEL_MAX_TOKENS=${CANDIDATE_MODEL_MAX_TOKENS}
MODEL_STRUCTURED_OUTPUTS_ENABLED=${MODEL_STRUCTURED_OUTPUTS_ENABLED}
CANDIDATE_FORMAT_MODEL_ENABLED=${CANDIDATE_FORMAT_MODEL_ENABLED}
CANDIDATE_FORMAT_BATCH_SIZE=${CANDIDATE_FORMAT_BATCH_SIZE}
...
RAG_EMBEDDING_TIMEOUT_SECONDS=${RAG_EMBEDDING_TIMEOUT_SECONDS:-120}
RAG_EMBEDDING_BATCH_SIZE=${RAG_EMBEDDING_BATCH_SIZE:-16}
RAG_EMBEDDING_MAX_CHARS=${RAG_EMBEDDING_MAX_CHARS:-16000}
RAG_EMBEDDING_ALLOW_HASH_FALLBACK=${RAG_EMBEDDING_ALLOW_HASH_FALLBACK:-true}
RAG_EMBEDDING_QUERY_PREFIX=${RAG_EMBEDDING_QUERY_PREFIX:-}
RAG_EMBEDDING_PASSAGE_PREFIX=${RAG_EMBEDDING_PASSAGE_PREFIX:-}
RAG_QDRANT_COLLECTION=${RAG_QDRANT_COLLECTION:-c_check_code_chunks}
MODEL_CATALOG_PATH=${MODEL_CATALOG_PATH:-${APP_DIR}/deploy/models/catalog.json}
MODEL_DEPLOYMENT_ENABLED=${MODEL_DEPLOYMENT_ENABLED:-false}
MODEL_DEPLOYMENT_SCRIPT=${MODEL_DEPLOYMENT_SCRIPT:-${APP_DIR}/deploy/models/deploy-vllm-model.sh}
